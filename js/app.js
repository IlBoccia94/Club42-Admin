...
import {loadMembersForRole} from './member-access.js?v=20260917-access3';
...
import {initNewsletter,loadNewsletter} from './newsletter.js?v=20260918-consentfix1';
...
buildNewsletterUi();
initSocialExtras();
configureRouter({onDashboard:loadDashboard,onUsers:loadUsers,onEvent:applyEventRoute,onSocial:loadSocial,onNewsletter:loadNewsletter,onMembers:loadMembersForRole,onCash:loadCash,onNotifications:loadNotifications,onProjects:loadProjects,onTasks:loadTasks,onContacts:loadContacts,onGuest:loadGuestPage});
initRouter();
initShell();
initEvents();
initNewsletter();
