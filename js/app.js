...
buildContactsUi();
initSocialExtras();
configureRouter({onUsers:loadUsers,onEvent:applyEventRoute,onSocial:loadSocial,onMembers:loadMembers,onProjects:loadProjects,onTasks:loadTasks,onContacts:loadContacts});
initRouter();
initShell();
initEvents();
initUsers();
