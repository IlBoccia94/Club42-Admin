...
buildContactsUi();
initSocialExtras();
configureRouter({onUsers:loadUsers,onEvent:applyEventRoute,onSocial:loadSocial,onMembers:loadMembers,onCash:loadCash,onProjects:loadProjects,onTasks:loadTasks,onContacts:loadContacts});
initRouter();
initShell();
initEvents();
initUsers();
