...
function openUser(id){const u=app.adminUsers.find(x=>x.user_id===id);if(!u)return;app.editUserId=id;$('uName').value=u.display_name||'';$('uEmail').value=u.email||'';$('uRole').value=u.role;$('uStatus').value=u.status;$('userDlg').showModal()}
