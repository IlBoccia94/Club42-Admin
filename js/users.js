...
function newsletterBadge(u){return u.newsletter_active?'<span class="newsletter-user-badge">Newsletter</span>':''}
...
export function initUsers(){
  ...
  $('inviteUserBtn').onclick=()=>{ensureRoleOptions();$('iName').value='';$('iEmail').value='';$('iRole').value='guest';resetInviteNewsletterForm();$('inviteDlg').showModal()};
